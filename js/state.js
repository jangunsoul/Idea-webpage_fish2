...
window.FISH_SCATTER_MIN_RADIUS = 1.0;
window.BOBBER_SCARE_RADIUS = 1.0;
window.FISH_SCATTER_FORCE = 14;
window.FISH_SCATTER_DURATION = 1.0;
window.FISH_ALERT_DURATION = 1.0;
window.BOBBER_SCARE_BASE_CHANCE = 0.4;
window.BOBBER_SCARE_PROBABILITY = {
  Common: 0.4,
  Uncommon: 0.45,
  Rare: 0.5,
  Epic: 0.55,
...
window.FISH_POPULATION_SCALE = 0.4;
